...
.PHONY: acceptance build chat coverage daemon doctor e2e install integration lint live-smoke package parity test
...
coverage:
	...
	@$(BAZEL) run //tools:coverage_gate -- --lcov "$(CURDIR)/bazel-out/_coverage/_coverage_report.dat" --minimum 75 --group "safety=100:agent_harness/safety.py" --group "deterministic=98:agent_harness/blobs.py,agent_harness/config.py,agent_harness/context.py,agent_harness/errors.py,agent_harness/goals.py,agent_harness/ids.py,agent_harness/models.py,agent_harness/projections.py,agent_harness/providers/normalize.py,agent_harness/routing.py,agent_harness/transfer.py,agent_harness/workspace.py" --group "execution=90:agent_harness/scheduler.py,agent_harness/storage.py,agent_harness/worker.py"
